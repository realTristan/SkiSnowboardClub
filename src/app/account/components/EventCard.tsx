...
export default function EventCard(props: { event: ClubEvent }): JSX.Element {
  ...
  return (
    <div className="relative flex h-auto w-80 flex-col items-start justify-start gap-1 border border-black bg-white p-7 duration-300 ease-in-out hover:scale-105">
      <Image
        src={event.image}
        alt="..."
        width={400}
