...
export default function Home() {
  return (
    <>
      ...
      <DarkOverlay className="z-0" />

      <MainWrapper
        className="flex-col p-10 md:p-24"
        style={{
      ...
      <p className="absolute bottom-0 left-1/2 z-10 mb-10 -translate-x-1/2 transform animate-pulse text-center text-base font-light text-white">
